...
export const serarchEndPriceRange = ({
  ...
  let high_price = daychartCoin.high_price;
  let opening_price = daychartCoin.opening_price;
  // opening_price
  let rate = (high_price - opening_price) / opening_price;
...
export const serarchLastbyStartPrice = ({
  ...
  let daychartCoin = daychart.data[0];
  let endprice = daychartCoin.trade_price;
  let startprice = daychartCoin.opening_price;
  let rate = (endprice - startprice) / startprice;
